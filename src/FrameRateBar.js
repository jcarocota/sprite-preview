...
export class FrameRateBar {
    ...
    //    ));
        ...
        console.log("this.handle.x", this.handle.x);
        console.log("this.slider.x + this.slider.width", this.slider.x, "+", this.slider.width, "=", this.slider.x + this.slider.width);
        if(this.handle.x > (this.slider.x + this.width)) {
            this.handle.x = this.slider.x + this.width;
        } else if(this.handle.x < this.slider.x) {
            this.handle.x = this.slider.x;
        }
