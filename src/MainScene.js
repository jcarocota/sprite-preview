...
export class MainScene {
  ...
  loadMainScene() {
    ...
    this.skinsButtonBar.init(
      skinsButtonBarBounds.x,
      skinsButtonBarBounds.y,
      skinsButtonBarBounds.width,
      skinsButtonBarBounds.height
    );
    this.container.addChild(this.skinsButtonBar.container);

    const playPauseButtonBounds = this.calculateBoundsPlayPauseBar();
    this.playPauseBar.init(
      playPauseButtonBounds.x,
      playPauseButtonBounds.y,
      playPauseButtonBounds.width,
      playPauseButtonBounds.height
    );
    ...
    this.animationButtonsBar.init(
      animationButtonsBarBounds.x,
      animationButtonsBarBounds.y,
      animationButtonsBarBounds.width,
      animationButtonsBarBounds.height
    );
    ...
    this.characterPreview.init(
      characterPreviewBouds.x,
      characterPreviewBouds.y,
      characterPreviewBouds.width,
      characterPreviewBouds.height
    );
    this.container.addChild(this.characterPreview.container);

    const frameRateBarBounds = this.calculateBoundsFrameRateBar();
    this.frameRateBar.init(
      frameRateBarBounds.x,
      frameRateBarBounds.y,
      frameRateBarBounds.width
    );
